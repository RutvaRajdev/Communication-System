...
public final class SocketNB {
	...
	private String parentalControl(String msg) {
		StringBuilder nonAbusiveMsg = new StringBuilder(" ** This message contains abusive language ** ");
		String[] words = msg.split(" ");
		for (String word : words) {
			if (Constant.abusiveWords.contains(word.toLowerCase())) return nonAbusiveMsg.toString();
		}
		return msg;
	}
	 ...
	 */
	protected int print(Message msg) {
		if (!isConnected()) {
