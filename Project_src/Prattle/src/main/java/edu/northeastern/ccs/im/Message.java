...
public class Message {
	...
	protected static Message makeMessage(String handle, String srcName, String text) {
		...
		if (handle.compareTo(MessageType.QUIT.toString()) == 0) {
			...
			result = makeMessageRelatedToGroup(handle,srcName,text);
		}
		return result;
	}
	...
	/**
	 * Given a handle, name and text, return the appropriate message instance or an
	 * instance from a subclass of message for group.
	 *
	 * @param handle  Handle of the message to be generated.
	 * @param srcName Name of the originator of the message (may be null)
	 * @param text    Text sent in this message (may be null)
	 ...
	 *         name, & text.
	 */
	protected static Message makeMessageRelatedToGroup(String handle, String srcName, String text) {
		Message result = null;
		if (handle.compareTo(MessageType.GRP_MSG.toString()) == 0) {
	 ...
	 * account
	 *
	 * @param srcName Name the user who wants to update the username
	 * @return Instance of Message that requests the update username
	 */
	...
	/**
	 * Determines if this message is of the delete type
	 * @return	true if the message is of the delete type
	 */
	public boolean isDeleteMessage() { return(msgType == MessageType.DELETE); }
    ...
    /**
	 * Determines if this message is of the update username type
	 * @return	true if the message is of the update username type
	 */
	public boolean isUpdateUsernameType() { return(msgType == MessageType.UPDATE_USERNAME); }

	/**
	 * Determines if this message is of the update password type
	 * @return	true if the message is of the update password type
	 */
	public boolean isUpdatePasswordType() { return(msgType == MessageType.UPDATE_PASSWORD); }
	...
	/**
	 * Determines if this message is private message
	 * @return	true if the message is private message
	 */
	public boolean isPrivateMessage() { return(msgType == MessageType.PRIVATE_MSG); }
	...
	/**
	 * Determines if this message is group message
	 * @return	true if the message is group message
	 */
	public boolean isGroupMessage() { return(msgType == MessageType.GRP_MSG); }
	...
	/**
	 * Determine if this message is sent by a new client to delete a group
	 *
	 * @return True if the message is a group deletion message; false otherwise
	 */
	public boolean isDeleteGroupMessage() { return (msgType == MessageType.DELETE_GRP); }
